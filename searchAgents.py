...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        space)
        """
        # start_state=(starting_position,checked corners)
        "*** YOUR CODE HERE ***"
    ...
    def isGoalState(self, state: Any):
        ...
        """
        # append the coordinates (x,y) to the visited_corners
        "*** YOUR CODE HERE ***"
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not wall_hit:
                ...
                if new_node in self.corners:
                    if new_node not in aux_corners:
...
def cornersHeuristic(state: Any, problem: CornersProblem):
    ...
    "*** YOUR CODE HERE ***"
    # sum of the unvisited corners does not work for the testcases, it expands fewer nodes but takes a longer path for the case
    # python3 pacman.py -l mediumCorners -p AStarCornersAgent -z 0.5
    # also tried with the sum//no_corners not visited but for the last testcase it expands too many nodes
    sum_distance = 0
    max_distance = 0
    no_corners = 0
    for corner in corners:
        if corner not in state[1]:
            ...
            if max_distance < mazeDistance(state[0], corner, problem.gamestate):
                max_distance = mazeDistance(state[0], corner, problem.gamestate)
    if no_corners == 0:
        return 0
    else:
        return sum_distance // no_corners
...
def foodHeuristic(state: Tuple[Tuple, List[List]], problem: FoodSearchProblem):
    ...
    for food in food_positions:
        dist = mazeDistance(position, food, start_position)
